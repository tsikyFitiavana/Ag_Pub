...
import { registerUser } from '../../actions/authClientsActions';
...
class SignupPage extends Component {
  ...
  handleSubmit = (e) => {
    e.preventDefault();
    const { name, email,adresse_exacte, password, passwordConfirm } = this.state;
    const user = {
      name,
      email,
      adresse_exacte,
        ...
        <main className={classes.layout}>
          <Paper className={classes.paper}>
            ...
            <form onSubmit={this.handleSubmit} noValidate>
              ...
              <FormControl margin="normal" required fullWidth>
                <InputLabel htmlFor="email">adresse exacte</InputLabel>
                <Input
                  onChange={this.handleInputChange}
                  id="adresse_exacte"
                  name="adresse_exacte"
                  autoComplete="adresse_exacte"
                  error={!!errors.email}
                />
              ...
              <FormControl margin="normal" required fullWidth>
                <InputLabel htmlFor="password">Numero phones</InputLabel>
                <Input
                  onChange={this.handleInputChange}
                  name="phones"
                  type="text"
